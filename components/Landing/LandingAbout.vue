<template>
  <section id="about" class="lg:px-40 px-6 my-16">
    ...
    <div class="mx-auto text-white">
      <!-- Title -->
      <div class="text-5xl font-bold pb-12">Hello</div>
      <!-- Text Bio -->
      <div class="text-lg tracking-normal leading-relaxed font-normal">
        <p class="pb-4">
          Hey 👋 ! I'm a french computer student in master degree known as Faceslog. I have always been passionate about technology and the endless possibilities it offers.
        </p>
        <p class="pb-4">
